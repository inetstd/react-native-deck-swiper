...
class Swiper extends Component {
  ...
  validPanResponderRelease = () => {
    ...
    const { isSwipingLeft, isSwipingRight, isSwipingTop, isSwipingBottom } = this.getSwipeDirection(this._animatedValueX, this._animatedValueY);
  ...
  getOnSwipeDirectionCallback = (animatedValueX, animatedValueY) => {
    ...
    const { isSwipingLeft, isSwipingRight, isSwipingTop, isSwipingBottom } = this.getSwipeDirection(animatedValueX, animatedValueY);
  ...
  renderFirstCard = () => {
    ...
    return (
      <Animated.View style={swipableCardStyle} key={firstCardIndex} {...this._panResponder.panHandlers}>
        {renderOverlayLabel}
        {firstCard}
      </Animated.View>
    );
  ...
  renderOverlayLabel = () => {
    ...
    return (
      <Animated.View style={this.calculateOverlayLabelWrapperStyle()}>
        {!overlayLabels[labelType].element && <Text style={this.calculateOverlayLabelStyle()}>{overlayLabels[labelType].title}</Text>}
